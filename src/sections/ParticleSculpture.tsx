...
export default function ParticleSculpture() {
  ...
  return (
    ...
    >
      <div
        className="particle-flex mx-auto flex flex-col md:flex-row gap-16"
        style={{ maxWidth: '1400px' }}
      >
        {/* Left column — Editorial text */}
        <div ref={textRef} className="particle-text-col w-full md:w-[45%]">
        ...
        <div className="particle-canvas-col w-full md:w-[55%] relative" style={{ minHeight: '500px' }}>
          <div
